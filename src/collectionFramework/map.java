...
public class map {
	public static void main(String[] args) {
		...
		int idToCheck = 1004;
		boolean existsKey = studentMap.containsKey(idToCheck);
		System.out.println("Student with ID " + idToCheck + " exists in records: " + existsKey);
		
		boolean existsValue = studentMap.containsValue("Michael Johnson");
		System.out.println("Student with name \"Michael Johnson\" exists in records: " + existsValue);
