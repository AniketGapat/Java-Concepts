...
public class StrOp {
	...
	public static void strOp() {
		...
		System.out.println("comparing string with string objects by '=':" + (str == str1)); // can not compare objects
																							// with '=='
		...
		System.out.println("comparing string objects by 'equals':" + str12.equals(str1)); // use to compare string
																							// objects
		...
		String str = " hi world this  is Aniket!";
